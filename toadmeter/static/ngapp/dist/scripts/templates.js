angular.module('Toadmeter').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/static/ngapp/app/scripts/auth/templates/login.html',
    ...
    "\n" +
    "            <div layout=\"row\" \n" +
    "                 style=\"font-size: 0.8rem; margin-top: -1.4rem; opacity: 0.5; font-style: italic;\">\n" +
    ...
    "            Log in <span ng-show=\"isDemoUser\">as read-only demo user</span>\n" +
    "        </span>\n" +
    "    </md-button>\n" +
    "    \n" +
    "    <md-button ui-sref=\"public.reg\" \n" +
    "               class=\"\">...or you can register</md-button>    \n" +
    "    \n" +
    "    \n" +
    "</md-content>\n" +
    "\n" +
